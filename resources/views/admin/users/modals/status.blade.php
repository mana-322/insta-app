        ...
        <div class="modal-content border-success">
            ...
            <div class="modal-footer border-0">
                <form action="{{ route('admin.users.activate', $user->id) }}" method="post">
                    ...
                    <button type="submit" class="btn btn-outline-success btn-sm" data-bs-toggle="modal">Cancel</button>
                    <button type="sibmit" class="btn btn-success btn-sm">Activate</button>
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content border-danger">
            ...
            <div class="modal-footer border-0">
                <form action="{{ route('admin.users.deactivate', $user->id) }}" method="post">
                    ...
                    <button type="sibmit" class="btn btn-danger btn-sm">Deactivate</button>
                </form>
            </div>
        </div>
    </div>
