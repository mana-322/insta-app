    ...
    <div class="modal-dialog">
        <div class="modal-content border-primary">
            ...
            <div class="modal-body">
                Are you sure want to unhinde this post?
                <div class="mt-3">
            ...
            <div class="modal-footer border-0">
                <form action="{{ route('admin.posts.unhide', $post->id) }}" method="post">
                    ...
                    <button type="submit" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal">Cancel</button>
                    <button type="sibmit" class="btn btn-primary btn-sm">Unhide</button>
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content border-danger">
            ...
            <div class="modal-footer border-0">
                <form action="{{ route('admin.posts.hide', $post->id) }}" method="post">
                    ...
                    <button type="submit" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal">Cancel</button>
                    <button type="sibmit" class="btn btn-danger btn-sm">Hide</button>
                </form>
            </div>
        </div>
    </div>
